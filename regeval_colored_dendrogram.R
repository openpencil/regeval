## Source code from: http://addictedtor.free.fr/packages/A2R/lastVersion/html/A2Rplot.hclust.html
## Code from: http://addictedtor.free.fr/packages/A2R/lastVersion/R/code.R
